document.getElementById("submitBtn").addEventListener("click", function() {
    ...
    const randomWords = ["gondoruwo", "tutup odol", "buaya brazil", "Setia", "samsuding", "miya hyper" "Topi Melorot", "Pocong Bersepeda", "Batu Bata", "suster mesok", "masako", "panji petualang", "kopi tuak", "miya Khalifah", "niroro gundul", "mak lampir"];
